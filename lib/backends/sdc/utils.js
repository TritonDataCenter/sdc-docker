...
// XXX pull all this out to affinity.js
...
function localityFromContainer(opts, cb) {
    ...
    // XXX update 'affinities' label with the merged value? WWDD?
...
/*
 * XXX doc this. Should this be a generic parse of all swarm "filters"?
 *
 * See: https://docs.docker.com/swarm/scheduler/filter/#how-to-write-filter-expressions
 */
