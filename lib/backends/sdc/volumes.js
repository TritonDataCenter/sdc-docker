 ...
 * volume's state, or until MAX_VOLUME_STATE_POLLS attempts have been made.
 *
...
function pollVolumeState(volumeUuid, volapiClient, states, callback) {
    ...
    var MAX_VOLUME_STATE_POLLS = 10 * 60; // 10 minutes
...
function createVolume(volumeParams, options, callback) {
    ...
    vasync.pipeline({funcs: [
        ...
        function parseAffinityHints(_, cb) {
            ...
            // TODO: It would be better if DAPI did this affinity parsing work
            // from the container labels/tags directly.
